...
public class StartDiscoverableModeActivity extends Activity {
    ...
    public static final String TAG = "DiscAct";
    ...
    private void showWarning() {
        ...
        warningDialog.setTitle("Bluetooth not enabled ");
        warningDialog.setMessage("warning");
        ...
        warningDialog.setNegativeButton("No", new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(self, "Discoverable mode NOT enabled.", Toast.LENGTH_LONG).show();
                finish();
            }
        });
